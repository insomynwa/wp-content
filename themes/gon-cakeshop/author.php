...
<div class="main-container">
	<div class="blog_header"><?php esc_html_e('Blog', 'gon-cakeshop'); ?></div>
				...
				<div class="page-content blog-page <?php echo esc_attr($blogclass); if($blogsidebar=='left') {echo ' left-sidebar'; } if($blogsidebar=='right') {echo ' right-sidebar'; } ?>">
					<?php if (have_posts()) : ?>
						...
						<header class="archive-header">
							<h1 class="archive-title"><?php printf(esc_html__('Author Archives: %s', 'gon-cakeshop'), '<span class="vcard"><a class="url fn n" href="' . esc_url(get_author_posts_url(get_the_author_meta("ID"))) . '" title="' . esc_attr(get_the_author()) . '" rel="me">' . get_the_author() . '</a></span>'); ?></h1>
						...
						<div class="author-info archives">
							...
							<div class="author-description">
								<h2><?php printf(esc_html__('About %s', 'gon-cakeshop'), get_the_author()); ?></h2>
