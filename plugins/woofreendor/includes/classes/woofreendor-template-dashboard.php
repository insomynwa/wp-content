...
class Woofreendor_Template_Dashboard {
    ...
    function __construct() {
        ...
        add_action( 'dokan_get_dashboard_nav', array($this, 'woofreendor_dashboard_nav') );
    ...
    function woofreendor_dashboard_nav($paramUrls){
        if ( woofreendor_is_user_tenant( get_current_user_id() ) ) {
            unset( $paramUrls['products'] );
            unset( $paramUrls['orders'] );
        }
        else {
