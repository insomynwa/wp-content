            ...
            <article class="dokan-product-listing-area">
                ...
                <div class="dokan-dahsboard-product-listing-wrapper">
                    <table class="dokan-table dokan-table-striped product-listing-table">
                        <thead>
                            <tr>
                                <th><?php _e( 'Gambar', 'dokan-lite' ); ?></th>
                                <th><?php _e( 'Nama Produk', 'dokan-lite' ); ?></th>
                                <th><?php _e( 'Status', 'dokan-lite' ); ?></th>
                                <th><?php _e( 'Stok', 'dokan-lite' ); ?></th>
                                <th><?php _e( 'Harga', 'dokan-lite' ); ?></th>
                                <th><?php _e( 'Dilihat', 'dokan-lite' ); ?></th>
                                <th><?php _e( 'Tanggal', 'dokan-lite' ); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            if ( $product_query->have_posts() ) {
                                while ($product_query->have_posts()) {
                                    ...
                                    <td data-title="<?php _e( 'Gambar', 'dokan-lite' ); ?>">
                                        <a href="<?php echo dokan_edit_product_url( $post->ID ); ?>"><?php echo $product->get_image(); ?></a>
                                    </td>
                                    <td data-title="<?php _e( 'Nama', 'dokan-lite' ); ?>">
                                        <p><a href="<?php echo dokan_edit_product_url( $post->ID ); ?>"><?php echo $product->get_title(); ?></a></p>

                                        <div class="row-actions">
                                            <span class="edit"><a href="<?php echo dokan_edit_product_url( $post->ID ); ?>"><?php _e( 'Ubah', 'dokan-lite' ); ?></a> | </span>
                                            <span class="delete"><a onclick="return confirm('Are you sure?');" href="<?php echo wp_nonce_url( add_query_arg( array( 'action' => 'dokan-delete-product', 'product_id' => $post->ID ), dokan_get_navigation_url('products') ), 'dokan-delete-product' ); ?>"><?php _e( 'Hapus Permanen', 'dokan-lite' ); ?></a>  </span>
                                            <span class="view <?php echo $view_class ?>"> | <a href="<?php echo get_permalink( dokan_get_prop( $product, 'id' ) ); ?>" rel="permalink"><?php _e( 'Lihat', 'dokan-lite' ); ?></a></span>
                                    ...
                                    <td data-title="<?php _e( 'Stok', 'dokan-lite' ); ?>">
                                        <?php
                                    ...
                                    <td data-title="<?php _e( 'Harga', 'dokan-lite' ); ?>">
                                        <?php
                                        ...
                                        <td data-title="<?php _e( 'Dilihat', 'dokan-lite' ); ?>">
                                ...
                                <?php } else { ?>
                                <tr>
                                    <td colspan="7"><?php _e( 'Produk tidak diketemukan.', 'dokan-lite' ); ?></td>
                                </tr>
                                <?php } ?>
