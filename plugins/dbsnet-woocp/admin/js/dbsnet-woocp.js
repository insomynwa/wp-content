	...
	$('body').on('focus','.custom-woocp-datepicker', function(){
     ...
     $("#add_row").click(function(){
      ...
      $('#addr'+i).html("<td>"+ (i+1)+"</td>"+
      	"<td><input name='batch_start_date[]' type='text' placeholder='Name' class='custom-woocp-datepicker'  /> </td>" +
      	"<td><input  name='batch_end_date[]' type='text' placeholder='Mail'  class='custom-woocp-datepicker'></td>" + 
      	"<td><input  name='batch_stock[]' type='number' placeholder='Mobile'  class=''></td>" +
      	"<td><input  name='batch_price[]' type='text' placeholder='Mobile'  class=''></td>" +
